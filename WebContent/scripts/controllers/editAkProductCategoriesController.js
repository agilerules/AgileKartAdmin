...
angular.module('agileRulesKart').controller('EditAkProductCategoriesController', function($scope, $routeParams, $location, AkProductCategoriesResource , AkProductsResource, AkCategoryOptionsResource) {
    var self = this;
